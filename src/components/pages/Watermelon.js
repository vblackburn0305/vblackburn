...
import sudanImage from '../../images/img-20.jpg'
import fieldImage from '../../images/img-21.jpg'
import sliceImage from '../../images/img-22.jpg'
  ...
  return (
    <div className="watermelon-container">
      ...
      <div className="country">
        <img src={sudanImage} alt="Sudan Flag" />
      ...
      <div className="country">
        <img src={fieldImage} alt="Watermelon Field" />
      ...
      <div className="country">
        <img src={sliceImage} alt="Watermelon Slice" className="short-image" />
